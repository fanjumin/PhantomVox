          ...
          _MenuButton(
            ...
            children: [
              MenuItemButton(
                ...
                child: const Tr('About PhantomVox'),
                onPressed: () => _showAbout(context),
              ),
              const Divider(height: 1),
              MenuItemButton(
                leadingIcon: const Icon(Icons.update, size: 14),
                child: const Tr('Check Updates'),
          ...
          _MenuButton(
            ...
            children: [
              ...
              MenuItemButton(
                ...
                child: const Tr('Scene Detection'),
          ...
          _MenuButton(
            ...
            children: [
              ...
              SubmenuButton(
                ...
                menuChildren: [
                  MenuItemButton(
                    child: const Tr('(recent projects)'),
                    onPressed: () {},
                  ),
                ],
                child: const Tr('Recent'),
              ),
              const Divider(height: 1),
              MenuItemButton(
              ...
              MenuItemButton(
                leadingIcon: const Icon(Icons.settings, size: 14),
                child: const Tr('Project Settings'),
                onPressed: () => onOpenSettings?.call(),
              ),
              MenuItemButton(
                leadingIcon: const Icon(Icons.model_training, size: 14),
                child: const Tr('Model Settings'),
                onPressed: () => onOpenSettings?.call(),
              ),
              const Divider(height: 1),
              MenuItemButton(
          ...
          _MenuButton(
            ...
            children: [
              ...
              MenuItemButton(
                ...
                child: const Tr('Screen Recording'),
