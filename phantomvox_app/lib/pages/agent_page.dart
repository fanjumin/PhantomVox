        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                _headerChip(i18n.tr('All Agents Active'), Colors.green),
              ],
            ),
          ),
          // Sub-tab bar
          Container(
            ...
            child: TabBar(
              ...
              tabs: [
                Tab(icon: const Icon(Icons.chat, size: 14), text: i18n.tr('Chat')),
                Tab(icon: const Icon(Icons.psychology, size: 14), text: i18n.tr('Think')),
                Tab(icon: const Icon(Icons.image, size: 14), text: i18n.tr('Image')),
                Tab(icon: const Icon(Icons.videocam, size: 14), text: i18n.tr('Video')),
                Tab(icon: const Icon(Icons.code, size: 14), text: i18n.tr('Code')),
              ],
            ),
          ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _agentActionBtn(i18n.tr('Pause'), Icons.pause),
                      const SizedBox(width: 4),
                      _agentActionBtn(i18n.tr('Adjust'), Icons.tune),
                      const SizedBox(width: 4),
                      _agentActionBtn(i18n.tr('Manual'), Icons.edit),
                    ],
                  ),
                ],
              ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(i18n.tr(agent['desc'] as String? ?? ''),
                style: TextStyle(
                  fontSize: 7,
                  color: active ? Colors.white60 : Colors.grey[600],
                ),
