...
| # | 工作区 | 状态 | 描述 |
|---|--------|------|------|
| 1 | **Flow Graph** | ✅ v0.3.78 | **基于树的创作流编辑器** — 聊天驱动生成（自然语言→完整树），可折叠树，节点详情面板，AI 扩展，版本管理（快照+恢复），导入/导出/保存/删除，四级树（主题→场景→节拍→子节拍） |
...
| | **Flow Graph** | **root, node, reorder, save, import, export, delete, generate, expand, versions, versions/save, versions/restore** | **✅ v0.3.78** |
| | **Auth** | **/register, /login, /refresh, /users/me** | **✅ v0.3.78（JWT + 令牌轮换）** |
