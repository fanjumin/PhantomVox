...
|---|-----------|--------|-------------|
| 1 | **Flow Graph** | ✅ v0.2.4 | DAG workflow orchestrator — visual node editor, scheduled tasks, workflow monitoring |
| 2 | **AI Agent** | ✅ v0.2.4 | Multi-agent control center — Chat, Think, Image Gen, Video Gen, Code Gen panels + 8-agent matrix |
| 3 | **StoryCut** | ✅ v0.2.4 | Story-driven quick cut — media browser, viewport, dual-layer timeline, AI QuickBar |
| 4 | **ProEdit** | ✅ v0.2.4 | Precision editing — media pool + toolbox, 6-tab inspector, 5-track timeline, mixer |
| 5 | **Palette** | ✅ v0.2.4 | Color grading — reference gallery, 15-node graph, 4-tab color tools (Wheels/Warper/Picker/Scopes) |
| 6 | **AudioForge** | ✅ v0.2.4 | Audio mixing — Fairlight-style meter bar, track list, wave timeline, 5-channel mixer, AI workshop |
| 7 | **EffectLab** | ✅ v0.2.4 | VFX compositing — dual viewport, Renderer3D1 inspector, frame timeline, node canvas |
| 8 | **Dashboard** | ✅ v0.2.4 | Launch page — welcome banner, recent projects, hardware report, AI quick cards, quick chat |
